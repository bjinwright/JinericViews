...
from externals.ragendja.pyutils import getattr_by_path
from externals.patch_forms.models import ModelMultipleChoiceField
...
#        if issubclass(self.reference_class,polymodel.PolyModel):
